...
#define HTP_MM_DEBUG_RETURN_MAGIC HTP_OPBATCH_DEBUG_RAW_Q4_0_MAGIC /* v10.21: per-slice MMID internals + quantizer A/B */
...
static inline void htp_mm_hvx_vtcm_layout_build(
    ...
    if (is_fused_qkv || is_fused_ffn) {
        ...
        if (kernel_type == HTP_MM_KERNEL_HVX_QUANT_ROW_RAW_Q4_0) {
            // v10.37: restore the v10.35 single-slot layout.  The v10.36
            // n_prefetch ring was correct but regressed 32-token generation.
